...
func (in *DependsOnSpec) DeepCopyInto(out *DependsOnSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DependsOnSpec.
func (in *DependsOnSpec) DeepCopy() *DependsOnSpec {
	if in == nil {
		return nil
	}
	out := new(DependsOnSpec)
	in.DeepCopyInto(out)
	return out
}
